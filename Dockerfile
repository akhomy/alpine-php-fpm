...
#Envs
ENV CRONTAB_ENABLED 0
ENV XDEBUG_VERSION 2.4.1 
ENV PHP_FPM_PORT 8000
#Sendmail settings
ENV PHP_SENDMAIL_PATH /usr/sbin/sendmail -t -i example:port
ENV PHP_SENDMAIL_HOST smtp.host
ENV PHP_SENDMAIL_PORT 1025
#Some perfomence vars
ENV PHP_MEMORY_LIMIT 256M
ENV PHP_MAX_EXECUTION_TIME 150
